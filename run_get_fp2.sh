...
$HADOOP_HOME/bin/hadoop streaming \
                -input /app/lbs/lbs-guiji/ident_traj/mark_i2c/2014031*  \
                -input /app/lbs/lbs-guiji/ident_traj/mark_i2c/2014030*  \
                -input /app/lbs/lbs-guiji/ident_traj/mark_i2c/201402*  \
                -input /app/lbs/lbs-guiji/ident_traj/mark_i2c/201401*  \
                -output $OUTPUT_NL/$OUTPUT \
                -mapper "sh -x py27/py27.sh get_point_stay.py " \
                -reducer "cat" \
                -jobconf ares.user=zhuozhengxing \
               -jobconf hadoop.job.ugi=lbs-da-off,lbs-da-off \
                -jobconf mapred.job.name="get_fp_from_3mnonth_trajectory_byuser" \
                -jobconf stream.reduce.streamprocessor.2="cat" \
                -jobconf mapred.reduce.tasks=3599 \
                -jobconf mapred.job.map.capacity=3500 \
                -jobconf mapred.job.reduce.capacity=1999\
                -jobconf stream.memory.limit=1500 \
