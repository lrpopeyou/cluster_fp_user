...
$HADOOP_HOME/bin/hadoop streaming \
                ...
                -reducer "sh -x py27/py27.sh cluster_by_user.py" \
                ...
                -jobconf mapred.job.name="get_fp_from_3mnonth_trajectory" \
                -jobconf stream.reduce.streamprocessor.2="sh -x py27/py27.sh cluster_by_grid.py" \
                -jobconf mapred.reduce.tasks=4099 \
                -jobconf mapred.job.map.capacity=4000 \
                -jobconf mapred.job.reduce.capacity=2999\
